...
def runtest(solver, modetype, runV, k1Val, pulseVal, pulseName, showcommand=True, sspcommand=True):
    ...
    if not sundials_failed:
        ...
        ## uncomment the correspongding lines in plot_linear_adv_rec.py to save the frames as png files
...
#     plt.savefig(f"step_attempts_erroru_LAR_{pulse_name}.png", bbox_inches="tight")
...
#     plt.savefig(f"step_attempts_errorv_LAR_{pulse_name}.png", bbox_inches="tight")
...
#     plt.savefig(f"step_attempts_erroruv_LAR_{pulse_name}.png", bbox_inches="tight")
...
#     fig.supylabel(' erroru ', fontsize=20)
#     plt.savefig(f"implicit_solves_erroru_LAR_{pulse_name}.png", bbox_inches="tight")
...
#     fig.supxlabel(' implicit-solves ', fontsize=20)
#     fig.supylabel(' errorv ', fontsize=20)
#     plt.savefig(f"implicit_solves_errorv_LAR_{pulse_name}.png", bbox_inches="tight")
...
#     fig.supxlabel(' implicit-solves ', fontsize=20)
#     fig.supylabel(' erroruv ', fontsize=20)
#     plt.savefig(f"implicit_solves_erroruv_LAR_{pulse_name}.png", bbox_inches="tight")
...
#     fig.supylabel(' erroru ', fontsize=20)
#     plt.savefig(f"runtime_erroru_LAR_{pulse_name}.png", bbox_inches="tight")
...
#     fig.supxlabel(' runtime ', fontsize=20)
#     fig.supylabel(' errorv ', fontsize=20)
#     plt.savefig(f"runtime_errorv_LAR_{pulse_name}.png", bbox_inches="tight")
...
#     fig.supxlabel(' runtime ', fontsize=20)
#     fig.supylabel(' erroruv ', fontsize=20)
#     plt.savefig(f"runtime_erroruv_LAR_{pulse_name}.png", bbox_inches="tight")




# # ###############################################################################################################################
# # # --------------------------- accepted steps vs l1erru ----------------------------------
# # fig, ax = plt.subplots(figsize=(15, 15))
# # for col_ind, k1Val in enumerate(k1values):
# #     k2Val = 2.0 * k1Val
...
# # fig.supxlabel(' step-attempts ', fontsize=20)
# # fig.supylabel(' l1erru ', fontsize=20)
# # plt.savefig("step_attempts_l1erru_LAR.png", bbox_inches="tight")

# # # --------------------------- accepted steps vs l1errv ----------------------------------
# # fig, ax = plt.subplots(figsize=(15, 15))
# # for col_ind, k1Val in enumerate(k1values):
# #     k2Val = 2.0 * k1Val
...
# # fig.supxlabel(' step-attempts ', fontsize=20)
# # fig.supylabel(' l1errv ', fontsize=20)
# # plt.savefig("step_attempts_l1errv_LAR.png", bbox_inches="tight")


# # # --------------------------- accepted steps vs l1erruv ----------------------------------
# # fig, ax = plt.subplots(figsize=(15, 15))
# # for col_ind, k1Val in enumerate(k1values):
# #     k2Val = 2.0 * k1Val
...
# # fig.supxlabel(' step-attempts ', fontsize=20)
# # fig.supylabel(' l1erruv ', fontsize=20)
# # plt.savefig("step_attempts_l1erruv_LAR.png", bbox_inches="tight")



# # # --------------------------- implicit solves vs l1erru ----------------------------------
# # fig, ax = plt.subplots(figsize=(15, 15))
# # for col_ind, k1Val in enumerate(k1values):
# #     k2Val = 2.0 * k1Val
...
# # fig.supxlabel(' implicit-solves ', fontsize=20)
# # fig.supylabel(' l1erru ', fontsize=20)
# # plt.savefig("implicit_solves_l1erru_LAR.png", bbox_inches="tight")

# # # --------------------------- implicit solves vs l1errv ----------------------------------
# # fig, ax = plt.subplots(figsize=(15, 15))
# # for col_ind, k1Val in enumerate(k1values):
# #     k2Val = 2.0 * k1Val
...
# # fig.supxlabel(' implicit-solves ', fontsize=20)
# # fig.supylabel(' l1errv ', fontsize=20)
# # plt.savefig("implicit_solves_l1errv_LAR.png", bbox_inches="tight")



# # # --------------------------- implicit solves vs l1erruv ----------------------------------
# # fig, ax = plt.subplots(figsize=(15, 15))
# # for col_ind, k1Val in enumerate(k1values):
# #     k2Val = 2.0 * k1Val
...
# # fig.supxlabel(' implicit-solves ', fontsize=20)
# # fig.supylabel(' l1erruv ', fontsize=20)
# # plt.savefig("implicit_solves_l1erruv_LAR.png", bbox_inches="tight")
...
# # fig.supxlabel(' runtime ', fontsize=20)
# # fig.supylabel(' l1erru ', fontsize=20)
# # plt.savefig("runtime_l1erru_LAR.png", bbox_inches="tight")
...
# # fig.supxlabel(' runtime ', fontsize=20)
# # fig.supylabel(' l1errv ', fontsize=20)
# # plt.savefig("runtime_l1errv_LAR.png", bbox_inches="tight")
...
# # fig.supxlabel(' runtime ', fontsize=20)
# # fig.supylabel(' l1erruv ', fontsize=20)
# # plt.savefig("runtime_l1erruv_LAR.png", bbox_inches="tight")
