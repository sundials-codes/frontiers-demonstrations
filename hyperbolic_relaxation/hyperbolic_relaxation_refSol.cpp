 ...
 * -----------------------------------------------------------------------------
 * This script generates the fully implicit reference solution for the 1D
 * hyperbolic relaxation problem with Arrhenius term.
 * 
...
int main(int argc, char* argv[])
{
  ...
  arkode_mem = ARKStepCreate(nullptr, fi, udata.t0, y, ctx);
